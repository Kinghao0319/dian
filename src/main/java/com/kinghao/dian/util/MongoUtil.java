...
public enum MongoUtil {
     ...
     *
     */
    public  void insert(MongoDatabase database,String collection, DBObject o) {


        database.getCollection(collection).insertOne(BsonUtil.toDocument(o));
    }
     ...
     *            插入的列表
     */
    public void insertBatch(MongoDatabase database,String collection, List<DBObject> list) {
        ...
        for (DBObject item: list)
        {
            ...
            document  = BsonUtil.toDocument(list);
